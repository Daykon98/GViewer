...
var graphOptions = {
    ...
    title: {
        text: "Average registered suicides over time"
    },
    subtitles: [{
        fontFamily: 'calibri',
		fontSize: 16,
...
function updateOptions(id)
{
    ...
    if (id === 'country' || id === 'age')
    {
        if (id !== 'age')
        {
            ...
            // Open connection
            ageRequest.open('POST', 'viewHandlers/suicides_AVGEvolution_handler/suicides_AVGEvolution_handler_ajax.php', true);
        ...
        if (id !== 'country')
        {
             ...
             // Open connection
             countryRequest.open('POST', 'viewHandlers/suicides_AVGEvolution_handler/suicides_AVGEvolution_handler_ajax.php', true);
             // Set up handler for when request finishes
...
function getData(data)
{
    ...
    // Open connection
    dataRequest.open('POST', 'viewHandlers/suicides_AVGEvolution_handler/suicides_AVGEvolution_handler_ajax.php', true);
    // Set up handler for when request finishes
