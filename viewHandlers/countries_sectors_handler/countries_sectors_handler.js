...
var graphOptions = {
    ...
    theme: "ligth1",
    title: {
        text: "Percentage for each economic sector"
    },
    subtitles: [{
        fontFamily: 'calibri',
		fontSize: 16,
...
var graphData = {
    ...
    indexLabelFormatter: function(e) {
        return e.dataPoint.name + ": " + (e.dataPoint.y * 100).toFixed(1) + "%";
    },
    dataPoints: []
};
...
function getData(data)
{
    ...
    // Open connection
    dataRequest.open('POST', 'viewHandlers/countries_sectors_handler/countries_sectors_handler_ajax.php', true);
