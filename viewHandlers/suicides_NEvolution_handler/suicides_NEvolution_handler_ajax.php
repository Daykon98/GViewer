<?php
	...
	require_once(dirname(__FILE__) . '/suicides_NEvolution_handler_prepared.php');
	...
	if ($db)
	{
		SuicidesNEvolutionPrepared::prepareQueries();
		...
		if ($id === 'country')
		{
			...
			$query = SuicidesNEvolutionPrepared::fetchCountry($country, $age);
		...
		elseif ($id === 'age')
		{
			$query = SuicidesNEvolutionPrepared::fetchAge($country, $age);
		...
		elseif ($id === 'data')
		{
			$query = SuicidesNEvolutionPrepared::fetchData($country, $age);
			$dataArray = array();
