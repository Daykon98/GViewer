...
abstract class Form
{
    ...
    private function generaFormulario($errores = array(), &$datos = array())
    {
	    ...
	    $html .= "<div class='row'>";
	    $html .= "<div class='col-6 offset-3 col-xs-12 offset-xs-0 custom-form '>";
    ...
    private function generaListaErrores($errores)
    {
        ...
        if (  $numErrores == 1 ) {
            $html .= "<ul class='list-group'><li class='list-group-item list-group-item-danger'>".$errores[0]."</li class='list-group-item list-group-item-danger'></ul>";
        } else if ( $numErrores > 1 ) {
            $html .= "<ul class='list-group'><li class='list-group-item list-group-item-danger'>";
            $html .= implode("</li><li class='list-group-item list-group-item-danger'>", $errores);
            $html .= "</li class='list-group-item list-group-item-danger'></ul>";
        }
        return $html;
    }
}
